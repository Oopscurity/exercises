...
function applyc(__$ctx, __$ref) {
    ...
    if (__$t === "content") {
        ...
        if (__$t === "image") {
            var __$t = !$$elem;
            if (__$t) {
                if (typeof __$ctx.ctx.content === "undefined" && (__$ctx.__$a0 & 4) === 0) {
...
function __$b2(__$ctx, __$ref) {
    ...
    var items__$3 = __$r__$5;
    if (!items__$3) return;
    return [ {
        elem: "main",
        content: [ {
            elem: "list",
            content: items__$3.map(function(item) {
                return [ {
                    elem: "item",
                    content: item
                } ];
            ...
            elem: "menu",
            content: items__$3.map(function() {
                return [ {
                    elem: "toggle"
                } ];
            })
...
function __$b19(__$ctx, __$ref) {
    ...
    return __$ctx.extend(function __$lb__$8() {
        var __$r__$9;
...
function __$b25(__$ctx, __$ref) {
    ...
    if (tag__$15) {
            ...
            if (isBEM__$14) {
                ...
                if (mix__$34) {
                    ...
                    for (var i__$39 = 0; i__$39 < mix__$34.length; i__$39++) {
                        var mixItem__$40 = mix__$34[i__$39];
                        typeof mixItem__$40 === "string" && (mixItem__$40 = {
                            block: mixItem__$40
                        });
                        var hasItem__$41 = mixItem__$40.block && (vBlock__$20 !== ctx__$13.block || mixItem__$40.block !== vBlock__$20) || mixItem__$40.elem, mixBlock__$42 = mixItem__$40.block || mixItem__$40._block || $$block, mixElem__$43 = mixItem__$40.elem || mixItem__$40._elem || $$elem;
                        ...
                        if (hasItem__$41 && !visited__$37[visitedKey__$38(mixBlock__$42, mixElem__$43)]) {
                            ...
                            if (nestedMix__$44) {
                                Array.isArray(nestedMix__$44) || (nestedMix__$44 = [ nestedMix__$44 ]);
        ...
        if (isBEM__$14 && jsParams__$24) {
            __$ctx._str += " data-bem='" + __$ctx.jsAttrEscape(JSON.stringify(jsParams__$24)) + "'";
        }
        var __$r__$52;
        var __$l9__$53 = $$mode;
        $$mode = "attrs";
